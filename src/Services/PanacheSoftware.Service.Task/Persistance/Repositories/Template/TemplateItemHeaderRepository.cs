...
{
    public class TemplateItemHeaderRepository : PanacheSoftwareRepository<TemplateItemHeader>, ITemplateItemHeaderRepository
    {
        public TemplateItemHeaderRepository(PanacheSoftwareServiceTaskContext context) : base(context)
        {
        }
