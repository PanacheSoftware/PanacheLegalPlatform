...
{
    public class TemplateDetailRepository : PanacheSoftwareRepository<TemplateDetail>, ITemplateDetailRepository
    {
        public TemplateDetailRepository(PanacheSoftwareServiceTaskContext context) : base(context)
        {
        }
