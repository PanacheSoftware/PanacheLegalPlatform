...
namespace PanacheSoftware.UI.Client.Pages.CustomFieldGroup
{
    ...
    public class CustomFieldGroupsModel : PageModel, IPanacheSoftwarePageModel
    {
        private readonly IAPIHelper _apiHelper;
        public CustomFieldGroupList customFieldGroupList { get; set; }
        public LangQueryList langQueryList { get; set; }
        public string SaveState { get; set; }
        public string ErrorString { get; set; }
        public SaveMessageModel SaveMessageModel { get; set; }

        public CustomFieldGroupsModel(IAPIHelper apiHelper)
        {
        ...
        public async Task<bool> PageConstructor(string saveState, string accessToken)
        {
            ...
            langQueryList = await _apiHelper.MakeLanguageQuery(accessToken, "EN", new long[] { 10121, 10124, 11000, 11001, 10200, 10201, 10204 });
